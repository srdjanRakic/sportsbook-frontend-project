...
export default {
  ...
  data: () => ({
    ...
    // Link colors selectpickers
    showLinkColorsPrimaryPicker: false,
    showLinkColorsSecondaryPicker: false,
    showLinkColorsTextPicker: false,
    showLinkColorsAccentPicker: false,
  }),
  computed: {
    globalColors() {
