...
export default {
  ...
  data: () => ({
    ...
    // Button colors selectpickers
    showButtonColorsPrimaryPicker: false,
    showButtonColorsSecondaryPicker: false,
    showButtonColorsTextPicker: false,
    showButtonColorsAccentPicker: false,
  }),
  computed: {
    globalColors() {
